...
public class DesktopWidget extends Application {
    ...
    private void launchClock(Group root) {
        ...
        Arc cHoures = new Arc(203, 150, 50, 50, 90, 360), cMin = new Arc(203, 150, 100, 100, 90, 360), cSec = new Arc(203, 150, 130, 130, 90, 360);
